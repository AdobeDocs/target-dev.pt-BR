...
description: Verifique se todas as etapas necessárias para carregar o Adobe Experience Platform Web SDK foram executadas na sequência correta.
feature: APIs/SDKs
level: Experienced
role: Developer
hide: true
...
![Inicializar diagrama de SDKs](/help/dev/patterns/assets/diagram-initiaze-sdk.png){width="600" zoomable="yes"}
...
![Carregar diagrama do SDK da API do visitante](/help/dev/patterns/assets/load-visitor-api-sdk.png){width="100" zoomable="yes"}
...
![Definir ID do cliente](/help/dev/patterns/assets/set-customer-id.png){width="100" zoomable="yes"}
...
![Configurar solicitação automática de carregamento de página](/help/dev/patterns/assets/configure-automatic-page-request.png){width="100" zoomable="yes"}
...
![Configurar diagrama de manipulação de cintilação](/help/dev/patterns/assets/flicker-handling.png){width="100" zoomable="yes"}
...
![Diagrama de mapeamento de dados](/help/dev/patterns/assets/data-mapping.png){width="100" zoomable="yes"}
...
![Diagrama de mapeamento de dados remoto](/help/dev/patterns/assets/remote-data-mapping.png){width="100" zoomable="yes"}
...
![Carregar diagrama do SDK da Web do Adobe Target](/help/dev/patterns/assets/load-web-sdk.png){width="100" zoomable="yes"}
