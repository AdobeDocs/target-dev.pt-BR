...
title: Como usar a função [!UICONTROL adobe.target.getOffers()]?
feature: at.js
...
## Chame [!UICONTROL getOffers()] para recuperar as exibições mais recentes com os parâmetros e parâmetros de perfil transmitidos
...
## Chame [!UICONTROL getOffers()] para recuperar mboxes com parâmetros e parâmetros de perfil transmitidos.
...
O exemplo a seguir mostra como executar um carga usando [!UICONTROL getOffers()] com at.js 2.*x*
