...
| Etapa | Descrição |
| --- | --- |
| 1 | A ID de visitante da Experience Cloud foi recuperada do [Serviço de Identidade da Adobe Experience Cloud](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=pt-BR&). |
