...
Para acessar as opções de **[!UICONTROL Configurações do Recommendations]**, abra o Target na [!DNL Adobe Experience Cloud] e, em seguida, clique em **[!UICONTROL Recomendações]** > **[!UICONTROL Configurações]**.

![imagem alt](assets/recs_settings.png)

As opções disponíveis são as seguintes:

| Configuração | Descrição |
|--- |--- |
| Mbox global personalizada | (Opcional) especifique a mbox personalizada global usada para atender às atividades do [!UICONTROL Target]. Como padrão, a mbox global usada pelo [!UICONTROL Target] é usada para [!UICONTROL Recomendações].<P>Observação: essa opção é definida na guia [!UICONTROL Target] **[!UICONTROL Administração]** página. Abertura [!UICONTROL Target]e, em seguida, clique em **[!UICONTROL Administração]** > **[!UICONTROL Visual Experience Composer]**. |
...
| [!UICONTROL Token de API do Recommendations] | Usar este token no [!UICONTROL Recommendations] Chamadas de API, como Baixar API. |
