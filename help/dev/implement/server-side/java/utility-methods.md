---
title: Usar métodos de utilitário no  [!DNL Adobe Target] Java SDK
...
Esses métodos auxiliares podem ser reutilizados nas controladoras e podem ser movidos para uma classe de utilitários separada.
