...
Para obter mais informações sobre TargetRequestUtils.java, consulte [Métodos de utilitário (Java)](https://experienceleague.corp.adobe.com/docs/target-dev/developer/server-side/java/utility-methods.html){target=_blank}
