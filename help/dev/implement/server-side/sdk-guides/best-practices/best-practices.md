...
description: Saiba mais sobre as práticas recomendadas ao usar a [!UICONTROL decisão no dispositivo] no [!DNL Adobe Target]
...
A [!DNL Adobe] recomenda as seguintes práticas recomendadas ao usar a [!UICONTROL decisão no dispositivo]:
...
* Se você tiver o Target Premium, poderá usar [properties/workspaces](https://experienceleague.adobe.com/docs/target/using/administer/manage-users/enterprise/property-channel.html?lang=pt-BR) para criar diferentes arquivos de artefatos para diferentes espaços de trabalho.
